...
__kernel void REPTree_15RUS_8D_4C(__global unsigned char* frame, const int width, __global bool* binMap)	//16x16 ONLY
{
    ...
    if (RANGE_MACRO_VALUE < 52.5) {
            if (X < 1192) {
                if (Y < 536) {
                    if (X < 744) {
                        ...
                        if (Y < 120) {
                            if (MAX_MACRO_VALUE < 46.5) {
                                ...
                                if (Y < 24) {
                                    if (AVG_MACRO_VALUE < 38.68) {
                                        binMap[i] = 1;
                                    }
                                    else if (AVG_MACRO_VALUE >= 38.68) {
                                        binMap[i] = 0;
                                    }
                                }
                                else if (Y >= 24) {
                    ...
                    if (X < 584) {
                        if (MIN_MACRO_VALUE < 17.5) {
                            if (Y < 1000) {
                                if (AVG_MACRO_VALUE < 31.44) {
                                    binMap[i] = 0;
                                }
                                else if (AVG_MACRO_VALUE >= 31.44) {
                                    if (Y < 664) {
                                        binMap[i] = 1;
                                    }
                                    else if (Y >= 664) {
                                ...
                                if (AVG_MACRO_VALUE < 21.04) {
                                    binMap[i] = 0;
                                }
                                else if (AVG_MACRO_VALUE >= 21.04) {
                                    if (AVG_ROW < 1.5) {
                                        binMap[i] = 1;
                                    }
                                    else if (AVG_ROW >= 1.5) {
                ...
                if (Y < 472) {
                    if (MAX_MACRO_VALUE < 170.5) {
                        if (MIN_MACRO_VALUE < 162.5) {
                            if (RANGE_MACRO_VALUE < 1.5) {
                                if (X < 1208) {
                                    if (AVG_MACRO_VALUE < 145.73) {
                                        binMap[i] = 0;
                                    }
                                    else if (AVG_MACRO_VALUE >= 145.73) {
                                        binMap[i] = 1;
                                    }
                                }
                                else if (X >= 1208) {
                    ...
                    if (X < 1560) {
                        if (Y < 936) {
                            if (X < 1320) {
                                ...
                                else if (AVG_MACRO_VALUE >= 21.07) {
                                    binMap[i] = 0;
                                }
                            }
                            else if (X >= 1320) {
                                if (MAX_MACRO_VALUE < 218.5) {
                                    binMap[i] = 0;
                                }
                                else if (MAX_MACRO_VALUE >= 218.5) {
                                    if (Y < 576) {
                                        binMap[i] = 1;
                                    }
                                    else if (Y >= 576) {
            ...
            if (Y < 360) {
                if (MIN_MACRO_VALUE < 59.5) {
                    ...
                    if (X < 1800) {
                        ...
                        if (RANGE_MACRO_VALUE < 102.5) {
                            if (Y < 264) {
                                if (Y < 24) {
                                    if (MAX_MACRO_VALUE < 208) {
                                        binMap[i] = 0;
                                    }
                                    else if (MAX_MACRO_VALUE >= 208) {
                                        binMap[i] = 1;
                                    }
                                }
                                else if (Y >= 24) {
                        ...
                        else if (RANGE_MACRO_VALUE >= 102.5) {
                            if (AVG_MACRO_VALUE < 134.64) {
                                if (AVG_MACRO_VALUE < 131.54) {
                                    binMap[i] = 0;
                                }
                                else if (AVG_MACRO_VALUE >= 131.54) {
                                    binMap[i] = 1;
                                }
                            }
                            else if (AVG_MACRO_VALUE >= 134.64) {
                                if (MAX_MACRO_VALUE < 227) {
                                    binMap[i] = 0;
                                }
                                else if (MAX_MACRO_VALUE >= 227) {
                                    binMap[i] = 1;
                                }
                            }
                        }
                ...
                if (MAX_MACRO_VALUE < 119.5) {
                    if (RANGE_MACRO_VALUE < 77.5) {
                        if (AVG_ROW < 12.5) {
                            if (Y < 872) {
                                ...
                                if (Y < 1032) {
                                    if (AVG_MACRO_VALUE < 59.01) {
                                        binMap[i] = 0;
                                    }
                                    else if (AVG_MACRO_VALUE >= 59.01) {
                                        binMap[i] = 1;
                                    }
                                }
                                else if (Y >= 1032) {
                                    if (AVG_MACRO_VALUE < 65.78) {
                                        binMap[i] = 1;
                                    }
                                    else if (AVG_MACRO_VALUE >= 65.78) {
                                        binMap[i] = 0;
                                    }
                                }
                            }
                        }
                        else if (AVG_ROW >= 12.5) {
                            if (X < 1592) {
                                binMap[i] = 0;
                            }
                            else if (X >= 1592) {
                        ...
                        if (MIN_MACRO_VALUE < 16.5) {
                            ...
                            if (AVG_MACRO_VALUE < 93.91) {
                                if (X < 968) {
                                    ...
                                    else if (AVG_COL >= 10.5) {
                                        binMap[i] = 1;
                                    }
                                }
                            }
                            else if (AVG_MACRO_VALUE >= 93.91) {
                                if (X < 1096) {
                    ...
                    if (X < 936) {
                        if (Y < 728) {
                            ...
                            else if (RANGE_MACRO_VALUE >= 126.5) {
